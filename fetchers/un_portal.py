"""
fetchers/un_portal.py — UN Partner Portal CFEI Fetcher
======================================================
Monitors the UN Partner Portal for open Calls for Expressions of Interest.
Requires UN_PORTAL_TOKEN env var. Skips gracefully if not set.
"""
